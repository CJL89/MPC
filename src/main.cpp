      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Latency for predicting time from actuation:
          ...
          // Transforming the points to the vehicles orentation:
          ...
          // Fitting the 3rd order of polys to the xy coordinates:
          auto coeffs = polyfit(ptsx_transform, ptsy_transform, 3);

          // Calculating the cross track eror:
          const double cte = polyeval(coeffs, 0);
          const double epsi = -atan(coeffs[1]);

          // Passing the predicted meassurements:
          Eigen::VectorXd state(6);
          state << 0.0, 0.0, 0.0, v, cte, epsi;

          // Solving new actuations:
